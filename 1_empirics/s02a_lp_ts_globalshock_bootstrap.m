...
% Bootstrap, sampling ARX residuals using Wild
% AB & DK, Jan 2026
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Transitory shock bands for short sample
% Read in data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for iboot = 1:nboot
    ...
    % explanatory variables
    bootshock = bootXraw(:,1);  % we treat shock as given here
...
writetable(TIRFs,'output/bootci_gshock_ts.csv')
...
writetable(TIRFs_trans,'output/bootci_gshock_trans_tsS.csv')


%% Transitory shock bands for long sample
% Read in data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
...
for iboot = 1:nboot
    ...
    % explanatory variables
    bootshock = Xraw(:,1); %.*(repmat(rr,1,1));
...
writetable(TIRFs_trans,'output/bootci_gshock_trans_tsL.csv')
